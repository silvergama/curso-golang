...
func main() {
	...
	i1 := math.MaxInt64
	fmt.Println("O valor máxinmo do int é", i1)
	fmt.Println("O tipo de i1 é", reflect.TypeOf(i1))

	var i2 rune = 'a' // representa um mapeamento da tabela Unicode (int32) -  Representação inteira de um determinado valor da tabela Unicode
